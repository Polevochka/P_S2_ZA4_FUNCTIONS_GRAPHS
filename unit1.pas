         ...
         begin
           ...
           begin
             ...
             begin
               ...
               // ширина столбца слишком маленькая и ПОЛНОСТЬЮ имена методов интегрирования
               // Не будут влезать, но будут влезать первые слова и будет понятно что за метод
               // AddCol(ArNameInteg[i], Arfx);

               // если это не подойдет то можно вручную записывать укороченные имена
               // методов интегрирования в ТАБЛИЦУ
               // например
               case i of
                 0: AddCol('Left', Arfx);
                 1: AddCol('Right', Arfx);
                 2: AddCol('Center', Arfx);
                 3: AddCol('Trapec', Arfx);
                 4: AddCol('Simpson', Arfx);
               end;
